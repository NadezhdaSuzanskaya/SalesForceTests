...
public class MainSteps extends AbstractStep {
    ...
    private static final String VALID_LOGIN_ENV =  PropertiesUtils.getEnv("valid_login");
    private static final String VALID_PASSWORD_ENV =  PropertiesUtils.getEnv("valid_password");
    ...
    public MainSteps loginWithValidCreds123() {
    ...
    public MainSteps loginWithValidCreds() {
        // loginPage.authentication(VALID_LOGIN, VALID_PASSWORD);
        loginPage.authentication(VALID_LOGIN_ENV, VALID_PASSWORD_ENV);
        homePage = new HomePage(driver);
        validatePageIsLoaded(homePage);
        return this;
    }
